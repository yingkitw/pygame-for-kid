...
block_img = ms.scale_block(pygame.image.load("rc/block.png"))
empty_img = ms.scale_block(pygame.image.load("rc/empty.png"))
bomb_img = ms.scale_block(pygame.image.load("rc/bomb.png"))
bomb_red_img = ms.scale_block(pygame.image.load("rc/bomb red.png"))
bomb_wrong_img = ms.scale_block(pygame.image.load("rc/bomb wrong.png"))
flag_img = ms.scale_block(pygame.image.load("rc/flag.png"))
mark1_img = ms.scale_block(pygame.image.load("rc/mark1.png"))
mark2_img = ms.scale_block(pygame.image.load("rc/mark2.png"))
mark3_img = ms.scale_block(pygame.image.load("rc/mark3.png"))
mark4_img = ms.scale_block(pygame.image.load("rc/mark4.png"))
mark5_img = ms.scale_block(pygame.image.load("rc/mark5.png"))
mark6_img = ms.scale_block(pygame.image.load("rc/mark6.png"))
mark7_img = ms.scale_block(pygame.image.load("rc/mark7.png"))
mark8_img = ms.scale_block(pygame.image.load("rc/mark8.png"))
win_img = pygame.transform.scale(pygame.image.load("rc/win.png"),(screen.get_width()/2,screen.get_height()/2))
